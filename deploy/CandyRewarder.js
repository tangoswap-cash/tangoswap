module.exports = async function ({ ethers, deployments, getNamedAccounts }) {
  ...
  const { address } = await deploy("CandyRewarder", {
    from: deployer,
  ...
  const rewarderContract = await ethers.getContract("CandyRewarder")
  console.log("dev:                ", dev);
  ...
  const owner = dev;
  const rewardPerSecond = '030000000000000000';
...
module.exports.tags = ["CandyRewarder"]
