module.exports = async function ({ ethers, deployments, getNamedAccounts }) {
  ...
  const { address } = await deploy("JoostRewarder", {
    from: deployer,
  ...
  const rewarderContract = await ethers.getContract("JoostRewarder")
  console.log("dev:                ", dev);
  ...
  const rewardToken = '0x387122d80A642581E5AD620696a37b98BB9272e7';
  const owner = dev;
  const rewardPerSecond = '800000000000000000';
  const masterLpToken =  '0x2a7c9D8E0E2286A596192C3C16Cc68979D331F29';
...
module.exports.tags = ["JoostRewarder"]
